...
export default function Header() {
  ...
  return (
    <div className="bg-black px-10 ">
      <div className="flex justify-between  items-center h-[110vh]">
        <div className="relative w-5/12 ">
          {/* <div className="absolute  w-16 h-14 border-b border-primary -left-4 top-16 rounded-l-full  "></div> */}

          <h1 className="text-4xl tracking-wider  text-white ">
            ABDERRAHIM OUAADDI
          </h1>
          <div className="text-white text-3xl mb-4 font-bold tracking-wider mt-8 flex ">
          ...
          <div className="text-white text-xl mb-4 font-bold flex items-center">
            {" "}
          ...
          <div className=" flex items-center mt-10">
            <button className="bg-primary tracking-wider py-3 px-4 mr-5 text-white hover:border border-primary hover:bg-inherit transition-all duration-500 flex items-end hover:text-primary">
              Download CV{" "}
            ...
            <button className="bg-primary tracking-wider py-3 px-4 text-white hover:border border-primary hover:bg-inherit transition-all duration-500 flex items-end hover:text-primary">
              Get in Touch{" "}
              <span className="ml-2 text-2xl ">
                <SiSocialblade />{" "}
              </span>
        ...
        <div className="text-white w-3/12 ml-2 ">
          <div className="flex items-center mb-2">
            <span>
              {" "}
              <GiFeather className="mr-2 fill-primary" />
            </span>{" "}
            <span className="font-light">Compétences en Web Développement </span>
          </div>
          <div className="flex items-center mb-2">
            <span>
              {" "}
          ...
          <div className="flex items-center mb-2">
            ...
            <span className="font-light">methodology Agile</span>
          </div>
          <div className="flex items-center mb-2">
            <span>
              {" "}
          ...
          <div className="flex items-center mb-2">
            ...
            <span className="font-light">motivated and flexible </span>
          </div>
        </div>
      </div>
